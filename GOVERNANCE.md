...
Code of conduct violations follow the process defined in [CODE_OF_CONDUCT.md](.github/CODE_OF_CONDUCT.md).
...
For pull request inactivity policy, see [Pull Request Inactivity Policy](docs/contributing/pull-request-process.md#pull-request-inactivity-policy) in the pull request process guide.
...
* Critical credentials (GitHub admin, CI/CD) are managed through Microsoft infrastructure
