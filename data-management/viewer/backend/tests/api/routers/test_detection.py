...
def test_run_detection_episode_not_found_returns_404(
...
def test_run_detection_success_returns_summary(
    client: TestClient, override_services
) -> None:
...
def test_run_detection_unexpected_error_returns_500(
    client: TestClient, override_services
) -> None:
    dataset_service, detection_service = override_services
...
def test_get_detections_returns_cached_summary(
    client: TestClient, override_services
) -> None:
...
def test_clear_detections_returns_cleared_status(
    client: TestClient, override_services
) -> None:
    _, detection_service = override_services
