...
describe('LanguageInstructionWidget', () => {
    ...
    it('adds and removes subtask instructions', async () => {
        ...
        expect(useAnnotationStore.getState().currentAnnotation?.languageInstruction?.subtaskInstructions).toEqual([
            'approach',
            'grasp',
        ])
    ...
    it('ignores blank paraphrase submissions', async () => {
        ...
        expect(useAnnotationStore.getState().currentAnnotation?.languageInstruction?.paraphrases).toEqual([])
    })
})
