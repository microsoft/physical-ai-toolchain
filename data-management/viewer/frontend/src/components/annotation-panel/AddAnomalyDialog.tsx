 ...
 * ```
 */
export function AddAnomalyDialog({ open, onClose, onAdd, currentFrame }: AddAnomalyDialogProps) {
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <FormSection label="Anomaly Type" htmlFor="anomaly-type">
              <Select value={type} onValueChange={(value) => setType(value as AnomalyType)}>
            ...
            >
              <div
                ...
                role="group"
                aria-labelledby="anomaly-frame-range-label"
              >
