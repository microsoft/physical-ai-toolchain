...
import { AlertTriangle, Check, CheckSquare, Loader2, Square, Star, X } from 'lucide-react'
      ...
      <CardContent className="p-4">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={onSelectAll} disabled={isProcessing}>
