...
Example configurations for different robot platforms and recording scenarios. Platform-specific recording configurations are in [`capture/config/examples/`](../capture/config/examples/).
