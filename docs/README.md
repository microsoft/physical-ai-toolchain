...
| [Inference](inference/README.md)                                              | Serving trained policies for local replay, SIL workflows, and ROS 2 runtime         | Available |
| [Evaluation](evaluation/README.md)                                            | SIL and policy evaluation workflows for Isaac Lab and LeRobot                       | Available |
| [Foundations](foundations/README.md)                                          | Conceptual foundations for RL, IL, and VLA design decisions                         | Available |
| [MLOps](mlops/README.md)                                                      | Training and SIL lifecycle blueprint for reproducibility and promotion readiness    | Available |
...
| Guide                                                                              | Description                                                                                                         |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [AzureML Validation Job Debugging](evaluation/azureml-validation-job-debugging.md) | Diagnosing and resolving AzureML validation job failures on AKS, including pod scheduling and resource quota issues |
