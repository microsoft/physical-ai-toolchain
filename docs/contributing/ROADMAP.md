...
The latest release recorded in [CHANGELOG.md](https://github.com/microsoft/physical-ai-toolchain/blob/main/CHANGELOG.md) is v0.8.0, dated 2026-05-08; `package.json` also reports 0.8.0.
