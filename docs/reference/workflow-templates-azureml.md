...
| Direct submission | Register the referenced environment asset first. The digest-derived version correlates the asset with an image but does not make Azure ML verify that image; submission scripts register the asset and verify its image.   |
