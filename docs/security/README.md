...
| [`scripts/security/Test-BinaryVersionFreshness.ps1`](https://github.com/microsoft/physical-ai-toolchain/blob/main/scripts/security/Test-BinaryVersionFreshness.ps1) | `check-binary-freshness.yml`       | Compare exact binary pins with upstream releases and detect inconsistent repository copies                                                                                                |
