...
| vpn\_gateway\_config              | VPN Gateway configuration including SKU, generation, and P2S client address pool                                                                                                                              | ```object({ sku = optional(string, "VpnGw1AZ") generation = optional(string, "Generation1") client_address_pool = optional(list(string), ["192.168.200.0/24"]) })```                                                                                                               | `{}`                            |    no    |
