              ...
              <div className="space-y-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    value={currentFrame}
                    onChange={(event) => onSetFrameWithinPlaybackRange(parseInt(event.target.value, 10))}
...
function renderDefaultControls({
  ...
  return (
    <>
      ...
      <Button size="sm" variant="outline" onClick={() => onStepFrame(-1)} disabled={isPlaying} title="Previous frame">
        <SkipBack className="h-4 w-4" />
      </Button>
      <Button size="sm" variant="outline" onClick={() => onStepFrame(1)} disabled={isPlaying} title="Next frame">
        <SkipForward className="h-4 w-4" />
      </Button>
      <Button size="sm" variant="outline" onClick={() => onSetFrameWithinPlaybackRange(playbackRangeStart)}>
        <RotateCcw className="h-4 w-4" />
      </Button>
