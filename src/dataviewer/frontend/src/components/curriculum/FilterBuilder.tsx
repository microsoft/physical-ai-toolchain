...
const FIELD_OPTIONS: Array<{ value: FilterField; label: string; type: 'number' | 'boolean' | 'string' }> = [
                ...
                <div className="flex items-center gap-2">
                  ...
                  {fieldType !== 'boolean' && (
                    <Input
                      ...
                      step={condition.field.includes('score') || condition.field.includes('rating') ? 1 : 0.1}
                    />
                  )}
