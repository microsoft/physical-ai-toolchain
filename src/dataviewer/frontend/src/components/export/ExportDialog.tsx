...
export function ExportDialog({
  ...
  const { isExporting, progress, result, error, startExport, cancelExport, reset } =
    useExport({ datasetId });
        ...
        {showProgress ? (
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="apply-edits">
                Apply crop, resize, and frame removal
              </Label>
            </div>
                ...
                <div>
                  ...
                  {applyEdits && effectiveFrameCount !== totalFrames && (
                    <span className="ml-1 text-xs">
                      (original: {totalFrames}, removed: {removedFrames.size}, inserted: {insertedFrames.size})
                    </span>
                  )}
                </div>
              )}
