...
export function FrameInsertionToolbar() {
  ...
  const { insertedFrames, insertFrame, removeInsertedFrame, clearInsertedFrames } = useFrameInsertionState();
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        <Label className="text-xs shrink-0">Blend Factor:</Label>
        <Input
          type="number"
          className="w-20 h-8"
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          />
          <Label className="text-xs shrink-0">frames, from</Label>
          <Input
            type="number"
            className="w-20 h-8"
            placeholder="0"
