...
import type { Detection, DetectionFilters, DetectionResult, EpisodeDetectionSummary } from '@/types/detection'
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={() => runDetection({ confidence: filters.minConfidence })} disabled={isRunning || isLoading}>
                {isRunning ? (
                  <>
