...
export function useAnnotationShortcuts(actions: {
  ...
  const shortcuts: KeyboardShortcut[] = [
    ...
    // Rating shortcuts
    { key: '1', action: () => actions.setRating(1), description: 'Rate 1 Star', category: 'annotation' },
    { key: '2', action: () => actions.setRating(2), description: 'Rate 2 Stars', category: 'annotation' },
    { key: '3', action: () => actions.setRating(3), description: 'Rate 3 Stars', category: 'annotation' },
    { key: '4', action: () => actions.setRating(4), description: 'Rate 4 Stars', category: 'annotation' },
    { key: '5', action: () => actions.setRating(5), description: 'Rate 5 Stars', category: 'annotation' },
    // Playback shortcuts
    {
      key: ' ',
