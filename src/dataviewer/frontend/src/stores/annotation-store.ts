  ...
  devtools(
    (set, get) => ({
        ...
        set(
          {
            currentAnnotation: {
              ...
              timestamp: new Date().toISOString(),
              anomalies: {
                anomalies: currentAnnotation.anomalies.anomalies.filter(
                  (a) => a.id !== id
                ),
              },
            },
      ...
      markSaved: () => {
        ...
        set(
          {
            originalAnnotation: currentAnnotation
              ? structuredClone(currentAnnotation)
              : null,
            isDirty: false,
            isSaving: false,
          },
        ...
        set(
          {
            currentAnnotation: originalAnnotation
              ? structuredClone(originalAnnotation)
              : null,
            isDirty: false,
            error: null,
          },
