...
Training environment setup scripts for container preparation, dependency installation, and runtime configuration. Scripts in this directory prepare the execution environment before training jobs run.
